...
describe("Regula Falsi method test", () => {
    ...
    test('should return the correct root for f(x) = x^3-x-1', function () {
        ...
        // Act
        const result = RegulaFalsiMethod.resolve(new Parameters(equation, x0, x1, acceptableError));
    ...
    test('should return the correct root  f(x) = x^2 ', () => {
        ...
        // Act
        const result = RegulaFalsiMethod.resolve(new Parameters(equation, lowerBound, upperBound, acceptableError));
